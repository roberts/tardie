                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                            ...
                            <div class="lg:order-first lg:row-span-2">
                                <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">"Thank you" -TaRDie bArbIE</h1>
                                <div class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                                    <p>Your submission has been received by TaRDie bArbIE!</p>
                                    <p>{{ $solana }}</p>
                                    <p>TaRDie bArbIE will take your Solana address and deliver a surprise to you when you least expect it. Be on the lookout for something in the coming days..</p>
                                    <p>TaRDie bArbIE also has your X handle (<a class="text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="{{ $xlink }}">{{ $handle }}</a>) & will reach out to you there in due time. In the meanwhile, continue to be like TaRDie bArbIE!</p>
                                </div>
                            </div>
                            <div class="lg:pl-20">
                                <ul role="list">
                                    <li class="flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://x.com/TardieBarbie">
                                            ...
                                            <span class="ml-4">@TardieBarbie</span>
                                        </a>
                                    </li>
                                    <li class="mt-4 flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="/about#">
                                            ...
                                            <span class="ml-4">t.me/TardieBarbie</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
