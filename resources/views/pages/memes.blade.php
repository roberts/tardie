                ...
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <header class="max-w-2xl">
                            <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">$BOB Memes are coming soon..</h1>
                            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">We are all Bob. Bob's meme lords are working hard right now to deliver you the best memes in the history of Bob:</p>
                        </header>
                        {{--
